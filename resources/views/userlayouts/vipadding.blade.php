...
@php
    ...
    //Easy English
    $basic_english=in_array( "Basic English Course", $courses)?true:false;
    $voa=in_array( "Let's Learn English (VOA)", $courses)?true:false;
    
    //Easy Korean
    $basic_korea=in_array( "Basic course", $courses)?true:false;
    $lv_one_korea=in_array( "Level One Course", $courses)?true:false;
    $lv_two_korea=in_array( "Level Two Course", $courses)?true:false;
    $lv_three_korea=in_array( "Level Three Course", $courses)?true:false;
    $lv_four_korea=in_array( "Level Four Course", $courses)?true:false;
    $kdrama=in_array( "Lesson With K-Drama", $courses)?true:false;
