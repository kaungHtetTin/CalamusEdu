...
<div class="row mb-4">
  ...
  <div class="col-12 mb-4">
    <div class="d-flex justify-content-between align-items-center">
      <div>
        <h2 class="mb-1" style="font-weight: 600; color: var(--text-primary);">Easy English Users</h2>
        <p class="mb-0 text-muted">Manage and view Easy English user data</p>
      </div>
      <div class="d-flex align-items-center gap-3">
        <div class="stat-card-mini" style="background: linear-gradient(135deg, #2196F3 0%, #1976D2 100%);">
...
<div class="card mb-4" style="border-radius: 12px; overflow: hidden;">
  <div class="card-header" style="background: rgba(33, 150, 243, 0.1); border-bottom: 1px solid rgba(33, 150, 243, 0.2);">
    <h5 class="mb-0" style="color: #2196F3; font-weight: 600;">
      <i class="fas fa-filter me-2"></i>Filter Users
    </h5>
  </div>
  <div class="card-body">
    <form method="GET" action="{{ route('filterEnglishUser') }}" class="filter-form">
      <div class="row g-3">
        <div class="col-md-3">
...
<div class="card modern-table-card">
  <div class="card-header modern-table-header">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
      <h5 class="mb-0">
        <i class="fas fa-users me-2"></i>Easy English Users
      </h5>
      <div class="d-flex align-items-center gap-3">
