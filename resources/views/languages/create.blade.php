            ...
            <div class="form-section col-lg-6 col-md-6">
              ...
              <div class="row">
                <div class="col-md-12 mb-3">
                  ...
                  <input type="text" class="form-control modern-input" id="name" name="name" value="{{old('name')}}" required maxlength="100" placeholder="e.g., English">
                ...
                <div class="col-md-12 mb-3">
                  ...
                  <input type="text" class="form-control modern-input" id="code" name="code" value="{{old('code')}}" required maxlength="20" placeholder="e.g., english">
                  <small class="text-muted">Unique code used in database (lowercase, no spaces)</small>
                </div>
                
                <div class="col-md-12 mb-3">
                  <label for="display_name" class="form-label">Display Name <span class="text-danger">*</span></label>
                  <input type="text" class="form-control modern-input" id="display_name" name="display_name" value="{{old('display_name')}}" required maxlength="100" placeholder="e.g., Easy English">
                ...
                <div class="col-md-12 mb-3">
                  ...
                  <input type="text" class="form-control modern-input" id="module_code" name="module_code" value="{{old('module_code')}}" required maxlength="10" placeholder="e.g., ee">
            ...
            <div class="form-section col-lg-6 col-md-6">
              ...
              <div class="row">
                <div class="col-md-6 mb-3">
                  ...
                  <input type="color" class="form-control form-control-color" id="primary_color" name="primary_color" value="{{old('primary_color', '#2196F3')}}">
                  <small class="text-muted">Primary theme color</small>
                </div>
                
                <div class="col-md-6 mb-3">
                  <label for="secondary_color" class="form-label">Secondary Color</label>
                  <input type="color" class="form-control form-control-color" id="secondary_color" name="secondary_color" value="{{old('secondary_color', '#1976D2')}}">
                  <small class="text-muted">Secondary theme color</small>
                </div>
                
                <div class="col-md-12 mb-3">
                  <label for="image_path" class="form-label">Image Path</label>
                  <input type="text" class="form-control modern-input" id="image_path" name="image_path" value="{{old('image_path')}}" maxlength="500" placeholder="e.g., /img/easyenglish.png">
                ...
                <div class="col-md-12 mb-3">
                  ...
                  <input type="text" class="form-control modern-input" id="notification_owner_id" name="notification_owner_id" value="{{old('notification_owner_id')}}" maxlength="20" placeholder="e.g., 1001">
                  <small class="text-muted">ID for notification system</small>
                </div>
                
                <div class="col-md-12 mb-3">
                  <label for="firebase_topic" class="form-label">Firebase Topic</label>
                  <input type="text" class="form-control modern-input" id="firebase_topic" name="firebase_topic" value="{{old('firebase_topic')}}" maxlength="100" placeholder="e.g., englishUsers">
                ...
                <div class="col-md-12 mb-3">
                  ...
                  <input type="text" class="form-control modern-input" id="user_data_table_prefix" name="user_data_table_prefix" value="{{old('user_data_table_prefix')}}" required maxlength="20" placeholder="e.g., ee">
                  <small class="text-muted">Prefix for user data table (e.g., 'ee' creates 'ee_user_datas')</small>
                </div>
                
                <div class="col-md-6 mb-3">
                  <label for="sort_order" class="form-label">Sort Order</label>
                  <input type="number" class="form-control modern-input" id="sort_order" name="sort_order" value="{{old('sort_order', 0)}}" min="0">
